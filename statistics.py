"""
NOTE: THIS VERSION IS EDITED AND HAS A METHOD 'StandardScore' ADDED IN BY VINNY WALKER
...
def StandardScore(data,sample):
    """Return the Standard Score (Z-Score) of a sample according to a dataset

    Data and sample do not need to be related

    >>> StandardScore([1, 5, 6, 3, 9], 2)
    -0.9231326627541018
    """
    mu = mean(data)
    sigma = stdev(data)
